...
6. Operacoes de Supabase (ferramentas/app Supabase, migrations) e deploy de Edge Functions **quando existente**.
...
- `AGENTS.md`
- `.context/modules/*` quando o plano envolver um modulo documentado
...
4. Supabase (quando aplicável):
   - Priorizar ferramentas/app Supabase disponiveis no Codex para inspecao/queries/configuracao.
   - Para migrations, detalhar preparo, aplicação e validação.
   - Incluir passo de leitura/confirmacao de schema antes de qualquer operacao Supabase sensivel.
...
## 7. Supabase: ferramentas/app + migrations (se aplicável)

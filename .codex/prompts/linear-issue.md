Gerencia issues no Linear (team **Onboarding / ONB**, workspace **aureatech**) via conector/ferramentas Linear disponiveis no Codex.
...
- Mencione convencoes do `AGENTS.md` quando relevante, por exemplo:

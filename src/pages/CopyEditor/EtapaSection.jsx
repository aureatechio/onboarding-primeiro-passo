...
const ETAPA_SCHEMAS = {
  ...
  etapa62: [
    ...
    { path: ['choiceAddNow'],            label: 'choiceAddNow',            type: FT.TEXTAREA },
    { path: ['choiceLater'],             label: 'choiceLater',             type: FT.TEXTAREA },
    { path: ['logoLabel'],               label: 'logoLabel',               type: FT.STRING },
    { path: ['coresTitle'],              label: 'coresTitle',              type: FT.STRING },
    { path: ['fonteTitle'],              label: 'fonteTitle',              type: FT.STRING },
    { path: ['imagensTitle'],            label: 'imagensTitle',            type: FT.STRING },
    { path: ['notesTitle'],              label: 'notesTitle',              type: FT.STRING },
    { path: ['notesPlaceholder'],        label: 'notesPlaceholder',        type: FT.TEXTAREA },
    { path: ['navConfirm'],              label: 'navConfirm',              type: FT.STRING },
    { path: ['navConfirmPending'],       label: 'navConfirmPending',       type: FT.STRING },
    { path: ['navContinueLater'],        label: 'navContinueLater',        type: FT.TEXTAREA },
    { path: ['processingMessages'],      label: 'processingMessages',      type: FT.STRING_ARRAY },
  ...
  etapa7: [
    ...
    { path: ['intro', 'title'],                    label: 'intro.title',                       type: FT.STRING },
    { path: ['intro', 'body'],                     label: 'intro.body',                        type: FT.TEXTAREA },
    { path: ['standard', 'title'],                 label: 'standard.title',                    type: FT.STRING },
    { path: ['standard', 'badge'],                 label: 'standard.badge',                    type: FT.STRING },
    { path: ['standard', 'desc'],                  label: 'standard.desc',                     type: FT.TEXTAREA },
    { path: ['hybrid', 'title'],                   label: 'hybrid.title',                      type: FT.STRING },
    { path: ['hybrid', 'badge'],                   label: 'hybrid.badge',                      type: FT.STRING },
    { path: ['hybrid', 'desc'],                    label: 'hybrid.desc',                       type: FT.TEXTAREA },
    { path: ['standardConfirmation', 'title'],     label: 'standardConfirmation.title',        type: FT.STRING },
    { path: ['standardConfirmation', 'body'],      label: 'standardConfirmation.body',         type: FT.TEXTAREA },
    { path: ['navConcluir'],                       label: 'navConcluir',                       type: FT.STRING },
    { path: ['navGerarIA'],                        label: 'navGerarIA',                        type: FT.STRING },
    { path: ['navConcluirSemIA'],                  label: 'navConcluirSemIA',                  type: FT.STRING },
    { path: ['processingSubmit'],                  label: 'processingSubmit',                  type: FT.STRING_ARRAY },
    { path: ['processingGenerate'],                label: 'processingGenerate',                type: FT.STRING_ARRAY },
    { path: ['completionTitle'],                   label: 'completionTitle',                   type: FT.STRING },
    { path: ['completionHybrid'],                  label: 'completionHybrid',                  type: FT.TEXTAREA },
    { path: ['completionStandard'],                label: 'completionStandard',                type: FT.TEXTAREA },
    { path: ['completionBadgeHybrid'],             label: 'completionBadgeHybrid',             type: FT.STRING },
    { path: ['completionBadgeStandard'],           label: 'completionBadgeStandard',           type: FT.STRING },
  ],
  ...
  etapaFinal: [
    ...
    { path: ['resumo', 'productionHybrid'], label: 'resumo.productionHybrid', type: FT.STRING },
    { path: ['resumo', 'productionStandard'], label: 'resumo.productionStandard', type: FT.STRING },

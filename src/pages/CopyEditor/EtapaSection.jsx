...
const ETAPA_SCHEMAS = {
  ...
  etapa2: [
    ...
    { path: ['slide4', 'nossaParte', 'label'], label: 'slide4.nossaParte.label', type: FT.STRING },
    { path: ['slide4', 'nossaParte', 'items'], label: 'slide4.nossaParte.items', type: FT.STRING_ARRAY },
    { path: ['slide4', 'suaParte', 'label'],   label: 'slide4.suaParte.label',   type: FT.STRING },
    { path: ['slide4', 'suaParte', 'items'],   label: 'slide4.suaParte.items',   type: FT.STRING_ARRAY },
  ...
  etapa3: [
    ...
    { path: ['slideTitles'],              label: 'slideTitles',          type: FT.STRING_ARRAY },
    { path: ['slideTags'],                label: 'slideTags',            type: FT.STRING_ARRAY },
    { path: ['prazosProducao'],           label: 'prazosProducao',       type: FT.NESTED_OBJECT },
  ...
  etapa4: [
    { path: ['header', 'readTime'],           label: 'header.readTime',             type: FT.STRING },
    { path: ['slideHeaders'],                 label: 'slideHeaders',                type: FT.OBJECT_ARRAY },
    ...
    { path: ['slide3', 'body'],               label: 'slide3.body',                 type: FT.TEXTAREA },
    { path: ['slide3', 'franquias'],          label: 'slide3.franquias',            type: FT.NESTED_OBJECT },
    { path: ['slide3', 'canaisDigitais'],     label: 'slide3.canaisDigitais',       type: FT.NESTED_OBJECT },
    { path: ['slide3', 'regrasPublicacao'],   label: 'slide3.regrasPublicacao',     type: FT.NESTED_OBJECT },
    { path: ['slide3', 'tvRadioOutdoor'],     label: 'slide3.tvRadioOutdoor',       type: FT.NESTED_OBJECT },
    { path: ['slide4', 'body'],               label: 'slide4.body',                 type: FT.TEXTAREA },
    { path: ['slide4', 'renovacao'],          label: 'slide4.renovacao',            type: FT.NESTED_OBJECT },
    { path: ['slide4', 'naoDisponivel'],      label: 'slide4.naoDisponivel',        type: FT.NESTED_OBJECT },
    { path: ['slide4', 'encerramento'],       label: 'slide4.encerramento',         type: FT.NESTED_OBJECT },
    { path: ['slide4', 'multa'],              label: 'slide4.multa',                type: FT.NESTED_OBJECT },
    { path: ['quizIntro'],                    label: 'quizIntro',                   type: FT.TEMPLATE, variables: ['celebName'] },
    { path: ['quizTitle'],                    label: 'quizTitle',                   type: FT.STRING },
    { path: ['quizSubtitle'],                 label: 'quizSubtitle',                type: FT.STRING },
    { path: ['quizQuestions'],                label: 'quizQuestions',               type: FT.STRING_ARRAY },
    { path: ['quizConfirmMessage'],           label: 'quizConfirmMessage',          type: FT.STRING },
    { path: ['completionTitle'],              label: 'completionTitle',             type: FT.STRING },
    { path: ['completionDescription'],        label: 'completionDescription',       type: FT.TEMPLATE, variables: ['celebName'] },
  ...
  etapa5: [
    ...
    { path: ['trafego', 'optionYesBadge'], label: 'trafego.optionYesBadge', type: FT.STRING },
    { path: ['trafego', 'optionNo'],     label: 'trafego.optionNo',     type: FT.STRING },
    { path: ['navNext'],                 label: 'navNext',               type: FT.STRING },
    { path: ['navNextSubmitting'],       label: 'navNextSubmitting',     type: FT.STRING },
    { path: ['completionTitle'],      label: 'completionTitle',   type: FT.STRING },
  ...
  etapa62: [
    ...
    { path: ['modoSimplificado', 'siteLabel'],            label: 'modoSimplificado.siteLabel',            type: FT.STRING },
    { path: ['modoSimplificado', 'sitePlaceholder'],      label: 'modoSimplificado.sitePlaceholder',      type: FT.STRING },
    { path: ['modoSimplificado', 'siteError'],            label: 'modoSimplificado.siteError',            type: FT.STRING },
    { path: ['modoSimplificado', 'instagramLabel'],       label: 'modoSimplificado.instagramLabel',       type: FT.STRING },
    { path: ['modoSimplificado', 'instagramPrefix'],      label: 'modoSimplificado.instagramPrefix',      type: FT.STRING },
    { path: ['modoSimplificado', 'instagramPlaceholder'], label: 'modoSimplificado.instagramPlaceholder', type: FT.STRING },
    { path: ['modoSimplificado', 'instagramError'],       label: 'modoSimplificado.instagramError',       type: FT.STRING },
    { path: ['colorPaletteLabel'],      label: 'colorPaletteLabel',      type: FT.STRING },
    { path: ['colorPaletteHint'],       label: 'colorPaletteHint',       type: FT.STRING },
    { path: ['colorPaletteAddButton'],  label: 'colorPaletteAddButton',  type: FT.STRING },
    { path: ['colorPaletteExtracting'], label: 'colorPaletteExtracting', type: FT.STRING },
    { path: ['colorPaletteMax'],        label: 'colorPaletteMax',        type: FT.STRING },
  ],
  ...
  etapaFinal: [
    ...
    { path: ['atendenteContactTime'],              label: 'atendenteContactTime',              type: FT.STRING },
    ...
    { path: ['parabens', 'stepLabel'],             label: 'parabens.stepLabel',                type: FT.STRING },
    { path: ['parabens', 'atendenteContact'],      label: 'parabens.atendenteContact',         type: FT.TEXTAREA },

...
**AI Campaign Pipeline:**
`create-ai-campaign-job`, `get-ai-campaign-status`, `get-ai-campaign-monitor`, `generate-campaign-briefing`, `save-campaign-briefing`, `suggest-briefing-seed`, `test-perplexity-briefing`, `generate-ai-campaign-image`, `retry-ai-campaign-assets`, `post-gen-generate`, `post-turbo-generate`, `discover-company-sources`, `read-nanobanana-reference`, `get-garden-job`, `list-garden-jobs`, `get-garden-options`
